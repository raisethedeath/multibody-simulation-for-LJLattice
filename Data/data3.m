...
%LJ1 = readmatrix('energy_conservation/conservation ,cell,ri=5,ro=15,dt=0.0001,t=0.4,v=1,t_tot=5,interval=0.1.csv ');
...
v= VideoWriter('cell,ri=5,ro=20,v=0.2,t_tot=10,interval=0.1,dt=0.00005');
