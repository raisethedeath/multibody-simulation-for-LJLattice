function plotEnergyComponents(filename, t_start,t_end,t_total,t_interval)
    ...
    %}
    %{
    semilogy(t, Ek-ymin,'b-^', 'DisplayName', 'Ek','LineWidth',0.5); hold on;
    semilogy(t, Ep-ymin,'r-s', 'DisplayName', 'Ep','LineWidth',0.5);
    semilogy(t, Et-ymin,'-o', 'DisplayName', 'Et','LineWidth',0.5,'Color',[1, 0.64706, 0]);
    %}
    % 添加图例和标签
    legend('show');
    ax = gca;
